...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-gpl --disable-shared --disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-avdevice --disable-indevs --disable-devices --disable-debug --disable-asm --disable-yasm --disable-doc --disable-bsfs --disable-ffplay --disable-ffprobe --disable-indevs --disable-outdevs --enable-cross-compile --cross-prefix='E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-' --enable-filter=aresample --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-small --enable-dct --enable-dwt --enable-lsp --enable-mdct --enable-rdft --enable-fft --enable-static --enable-version3 --enable-nonfree --disable-encoders --enable-encoder=pcm_s16le --enable-encoder=aac --enable-encoder=libmp3lame --enable-encoder=libvo_aacenc --enable-encoder=libfdk_aac --enable-encoder=libx264 --enable-encoder=mp2 --disable-decoders --enable-decoder=aac --enable-decoder=mjpeg --enable-decoder=png --enable-decoder=gif --enable-decoder=mp3 --enable-decoder=h264 --enable-decoder=pcm_s16le --disable-parsers --enable-parser=mjpeg --enable-parser=png --enable-parser=aac --enable-parser=h264 --enable-parser=mpeg4video --enable-parser=mpegvideo --enable-parser=mpegaudio --disable-muxers --enable-muxer=avi --enable-muxer=flv --enable-muxer=mp4 --enable-muxer=m4v --enable-muxer=mp3 --enable-muxer=mov --enable-muxer=h264 --enable-muxer=wav --enable-muxer=adts --disable-demuxers --enable-demuxer=mjpeg --enable-demuxer=m4v --enable-demuxer=gif --enable-demuxer=mov --enable-demuxer=avi --enable-demuxer=flv --enable-demuxer=h264 --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=wav --disable-protocols --enable-protocol=rtmp --enable-protocol=file --enable-protocol=http --disable-filters --enable-filter=transpose --enable-filter=crop --enable-filter=vflip --enable-filter=hflip --sysroot='E:/ndk/android-ndk-r12b/platforms/android-21/arch-arm' --prefix='E:/ffmpeg-4.0.2/ffmpeg-4.0.2/android/build/lib'
...
INTRINSICS=none
EXTERN_PREFIX=
CC=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
CXX=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-g++
AS=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
OBJCC=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
LD=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
AR_CMD=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-ar
NM_CMD=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-nm -g
RANLIB=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=echo skipping strip
STRIPTYPE=
NVCC=nvcc
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=E:/ndk/android-ndk-r12b/platforms/android-21/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
...
LD_PATH=-L
DLLTOOL=
WINDRES=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=E:/ndk/android-ndk-r12b/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS=  --sysroot=E:/ndk/android-ndk-r12b/platforms/android-21/arch-arm -march=armv5te -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
